...
public class RosterTest {
    ...
    public void testGetGiveeCode() {
        Assert.assertEquals("DavBol", roster.getRoledPlayerCode("TroBro", 0, 0));
        Assert.assertEquals("DunKei", roster.getRoledPlayerCode("AdaBur", 0, 0));
        Assert.assertNull(roster.getPlayerName("X"));
    }

    @Test
    public void testGetGiverCode() {
        Assert.assertEquals("JonToe", roster.getRoledPlayerCode("AdaBur", 0, 1));
        Assert.assertEquals("DavBol", roster.getRoledPlayerCode("PatSha", 0, 1));
        Assert.assertNull(roster.getPlayerName("X"));
    }
...
//        Assert.assertEquals("DunKei", roster.setGiveeCode("AdaBur", "MarHos", 0));
...
//        Assert.assertEquals("JonToe", roster.setGiverCode("AdaBur", "MarHos", 0));
...
//        Assert.assertEquals("none", roster.getGiverCode("AdaBur", 1));
//    }
//
//    @Test
